...
also touches something else named `repository`; adding
`atlas_kernel/outreach/unreviewed.py` alongside a change to `repository.py` is
what selected it.
