...
_Written by `infra/devloop/driver.py` at 2026-09-01T19:00:43+00:00. The queue is the source of truth; this is its projection._

- **3 done** · 0 in flight · 2 queued
- **1 waiting on a person** · 2 contested · 2 blocked
...
- **Why each outreach draft is unreviewed, from the records** — 2 finding(s) after 1 round(s).
