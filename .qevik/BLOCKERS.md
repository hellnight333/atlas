...
|---|---|---|---|---|---|---|---|---|
| B-01 | qevik.ai has no MX, SPF, DMARC or DKIM | DNS | C-13, C-14 | Cloudflare zone | HA-001 | Yes — CRM, control plane, productization | `deliverability.measure()` reports MX, SPF and DMARC present | OPEN |
